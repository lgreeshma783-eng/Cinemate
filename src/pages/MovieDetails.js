...
export const MovieDetails = () => {
  ...
  return (
    <main>
      <section className="flex justify-round flex-wrap py-5">
        <div className="max-w-sm">
        <img className="rounded" src={image} alt={movie.title} />
        </div>
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white mx-8">
          <h1 className="text-4xl font-bold my-3 text-cnter lg;text-left">{movie.title}</h1>
